            ...
            <div className="h-full border border-border bg-card text-card-foreground rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                <div className="relative group overflow-hidden bg-muted">
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center duration-250">
                        <a href={props.preview} target="_blank" rel="noreferrer" className="text-white mx-2 hover:text-primary-foreground bg-slate-900 hover:bg-primary py-3 px-3 mr-4 border border-white/20 rounded-full transition-all hover:scale-105">
                            <Eye size={24} />
                        </a>
                        <a href={props.github} target="_blank" rel="noreferrer" className="text-white mx-2 hover:text-primary-foreground bg-slate-900 hover:bg-primary py-3 px-3 border border-white/20 rounded-full transition-all hover:scale-105">
