                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="flex sm:justify-end">
                                <Link
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex items-center justify-center gap-2 whitespace-nowrap rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-md transition-all duration-300 hover:opacity-90 hover:shadow-lg sm:px-5 sm:py-2.5 sm:text-base"
                                >
                                    <LinkIcon size={18} />
                                    Connect With Me
                                </Link>
